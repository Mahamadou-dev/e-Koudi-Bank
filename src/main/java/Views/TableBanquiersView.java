...
public class TableBanquiersView extends JFrame {
    public TableBanquiersView(List<Banquier> banquiers) {
        setTitle("Liste des Banquiers");
        setSize(800, 600);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setLocationRelativeTo(null);

        // Colonnes du tableau
        String[] colonnes = {"ID", "Nom", "Prénom", "Email", "Salaire"};

        // Données du tableau
        DefaultTableModel model = new DefaultTableModel(colonnes, 0);
        for (Banquier b : banquiers) {
            model.addRow(new Object[]{b.getId(), b.getNom(), b.getPrenom(), b.getMail(), b.getSalaire()});
        }
